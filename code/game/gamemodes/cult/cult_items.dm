...
/obj/item/weapon/melee/cultblade/attack(mob/living/target as mob, mob/living/carbon/human/user as mob)
	if(iscultist(user))
		...
		user.Paralyse(5)
		user << "<span class='alert'>An unexplicable force powerfully repels the sword from [target]!</span>"
...
/obj/item/weapon/melee/cultblade/pickup(mob/living/user as mob)
	if(!iscultist(user))
		user << "<span class='alert'>An overwhelming feeling of dread comes over you as you pick up the cultist's sword. It would be wise to be rid of this blade quickly.</span>"
		user.make_dizzy(120)
