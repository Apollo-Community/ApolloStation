...
/datum/game_mode/proc/equip_wizard(mob/living/carbon/human/wizard_mob)
	...
	if(wizard_mob.backpack == 2) wizard_mob.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack(wizard_mob), slot_back)
	if(wizard_mob.backpack == 3) wizard_mob.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_norm(wizard_mob), slot_back)
	if(wizard_mob.backpack == 4) wizard_mob.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel(wizard_mob), slot_back)
