...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	if(synd_mob.backpack == 2) synd_mob.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack(synd_mob), slot_back)
	if(synd_mob.backpack == 3) synd_mob.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel_norm(synd_mob), slot_back)
	if(synd_mob.backpack == 4) synd_mob.equip_to_slot_or_qdel(new /obj/item/weapon/storage/backpack/satchel(synd_mob), slot_back)
