...
/obj/machinery/computer/atmoscontrol/attackby(var/obj/item/I as obj, var/mob/user as mob)
	if(istype(I, /obj/item/weapon/card/emag) && !emagged)
		user.visible_message("<span class='alert'>\The [user] swipes \a [I] through \the [src], causing the screen to flash!</span>",\
			"<span class='alert'>You swipe your [I] through \the [src], the screen flashing as you gain full control.</span>",\
