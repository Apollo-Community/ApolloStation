	...
	if(istype(W, /obj/item/weapon/screwdriver))
		...
		if(health < maxhealth)
			if(open)
				...
				user.visible_message("<span class='alert'> [user] repairs [src]!</span>","<span class='notice'> You repair [src]!</span>")
			else
...
/obj/machinery/bot/attack_hand(var/mob/living/carbon/human/user)
	...
	if(user.species.can_shred(user))
		...
		src.visible_message("<span class='alert'> <B>[user] has slashed [src]!</B></span>")
