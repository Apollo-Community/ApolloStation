/datum/job/engineer_assistant
	...
	access = list(access_eva, access_engine, access_engine_equip, access_maint_tunnels, access_external_airlocks, access_construction)
...
/datum/job/engineer_assistant/make_preview_icon( var/backpack , var/job , var/gender )
	var/icon/clothes_s = null

	clothes_s = new /icon('icons/mob/uniform.dmi', "yellow_s")
