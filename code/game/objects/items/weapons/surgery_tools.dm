...
/obj/item/weapon/surgicaldrill
	...
	suicide_act(mob/user)
		viewers(user) << pick("<span class='alert'><b>[user] is pressing the [src.name] to \his temple and activating it! It looks like \he's trying to commit suicide.</b></span>", \
							"<span class='alert'><b>[user] is pressing [src.name] to \his chest and activating it! It looks like \he's trying to commit suicide.</b></span>")
		return (BRUTELOSS)
