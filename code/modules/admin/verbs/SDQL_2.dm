		...
		if(op != "")
			switch(op)
				...
				if("or", "||")
					...
					usr << "<span class='alert'>SDQL2: Unknown op [op]</span>"
					result = null
		else
			result = val
...
/proc/SDQL2_tokenize(query_text)
	...
	for(var/i = 1, i <= len, i++)
		...
		if(char in whitespace)
			...
			if(word != "")
				usr << "<span class='alert'>SDQL2: You have an error in your SDQL syntax, unexpected ' in query: \"<font color=gray>[query_text]</font>\" following \"<font color=gray>[word]</font>\". Please check your syntax, and try again.</span>"
				return null
			...
			if(i > len)
				usr << "<span class='alert'>SDQL2: You have an error in your SDQL syntax, unmatched ' in query: \"<font color=gray>[query_text]</font>\". Please check your syntax, and try again.</span>"
				return null
