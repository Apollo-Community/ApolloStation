...
/datum/surgery_step/head/peel
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if (affected.parent)
			...
			user.visible_message("<span class='alert'>[user]'s hand slips, ripping [target]'s [affected.display_name] open!</span>", \
			"<span class='alert'>Your hand slips,  ripping [target]'s [affected.display_name] open!</span>")
...
/datum/surgery_step/head/shape
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if (affected.parent)
			affected = affected.parent
			user.visible_message("<span class='alert'>[user]'s hand slips, further rending flesh on [target]'s neck!</span>", \
			"<span class='alert'>Your hand slips, further rending flesh on [target]'s neck!</span>")
...
/datum/surgery_step/head/suture
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if (affected.parent)
			affected = affected.parent
			user.visible_message("<span class='alert'>[user]'s hand slips, ripping apart flesh on [target]'s neck!</span>", \
			"<span class='alert'>Your hand slips, ripping apart flesh on [target]'s neck!</span>")
			target.apply_damage(10, BRUTE, affected)
...
/datum/surgery_step/head/prepare
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if (affected.parent)
			affected = affected.parent
			user.visible_message("<span class='alert'>[user]'s hand slips, searing [target]'s neck!</span>", \
...
/datum/surgery_step/head/attach
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/datum/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("<span class='alert'>[user]'s hand slips, damaging connectors on [target]'s neck!</span>", \
		"<span class='alert'>Your hand slips, damaging connectors on [target]'s neck!</span>")
