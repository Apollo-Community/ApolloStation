...
/datum/surgery_step/slime/cut_flesh
	...
	fail_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		user.visible_message("<span class='alert'>[user]'s hand slips, tearing [target]'s flesh with \the [tool]!</span>", \
		"<span class='alert'>Your hand slips, tearing [target]'s flesh with \the [tool]!</span>")
...
/datum/surgery_step/slime/cut_innards
	...
	fail_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		user.visible_message("<span class='alert'>[user]'s hand slips, tearing [target]'s innards with \the [tool]!</span>", \
		"<span class='alert'>Your hand slips, tearing [target]'s innards with \the [tool]!</span>")
...
/datum/surgery_step/slime/saw_core
	...
	fail_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		user.visible_message("<span class='alert'>[user]'s hand slips, causing \him to miss the core!</span>", \
		"<span class='alert'>Your hand slips, causing you to miss the core!</span>")