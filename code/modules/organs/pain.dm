...
mob/living/carbon/proc/pain(var/partname, var/amount, var/force, var/burning = 0)
	...
	if(burning)
		switch(amount)
			if(1 to 10)
				msg = "<span class='alert'> <b>Your [partname] burns.</b></span>"
			if(11 to 90)
				flash_weak_pain()
				msg = "<span class='alert'> <b><font size=2>Your [partname] burns badly!</font></b></span>"
			if(91 to 10000)
				flash_pain()
				msg = "<span class='alert'> <b><font size=3>OH GOD! Your [partname] is on fire!</font></b></span>"
	else
		switch(amount)
			if(1 to 10)
...
mob/living/carbon/human/proc/custom_pain(var/message, var/flash_strength)
	...
	if(analgesic)
		return
	var/msg = "<span class='alert'> <b>[message]</b></span>"
	if(flash_strength >= 1)
		msg = "<span class='alert'> <font size=3><b>[message]</b></font></span>"
