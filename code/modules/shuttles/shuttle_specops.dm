...
/datum/shuttle/ferry/multidock/specops/launch(var/user)
	...
	if (location)
		var/obj/machinery/light/small/readylight/light = locate() in current_hanger.hanger_area_turfs
...
/datum/shuttle/ferry/multidock/specops/cancel_launch()
	...
	if (istype(in_use, /obj/machinery/computer))
		...
		C.visible_message("<span class='alert'>Launch sequence aborted.</span>")
