...
datum/design/rust_fuel_compressor
	...
	build_type = IMPRINTER
	materials = list("$glass" = 3000, "sacid" = 20, "$diamond" = 2000)
...
/obj/item/weapon/circuitboard/rust_core
	...
	board_type = "machine"
	origin_tech = "bluespace=3;magnets=5;powerstorage=6"
...
datum/design/rust_core
	...
	id = "pacman"
	req_tech = list(bluespace = 3, magnets = 5, powerstorage = 6)
	build_type = IMPRINTER
	reliability_base = 79
	materials = list("$glass" = 3000, "sacid" = 20, "$diamond" = 3000)
...
/obj/item/weapon/circuitboard/rust_injector
	...
	board_type = "machine"
	origin_tech = "powerstorage=3;engineering=4;materials=6"
...
datum/design/rust_injector
	...
	id = "pacman"
	req_tech = list(powerstorage = 3, engineering = 4, materials = 6)
	build_type = IMPRINTER
	reliability_base = 79
	materials = list("$glass" = 3000, "sacid" = 20, "$uranium" = 3000)
	build_path = "/obj/item/weapon/circuitboard/rust_core"
