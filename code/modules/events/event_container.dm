...
/datum/event_container/mundane
	...
	available_events = list(
		...
		// Higher weight = higher chance to run
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Space vines",				/datum/event/spacevine, 				200,	list(ASSIGNMENT_ENGINEER = 25)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Meteor Shower",			/datum/event/meteor_wave,				300,	list(ASSIGNMENT_ENGINEER = 20)),
		//new /datum/event_meta(EVENT_LEVEL_MODERATE, "Communication Blackout",	/datum/event/communications_blackout,	500,	list(ASSIGNMENT_AI = 150, ASSIGNMENT_SECURITY = 120)), // Doesn't work
		//new /datum/event_meta(EVENT_LEVEL_MODERATE, "Prison Break",				/datum/event/prison_break,				0,		list(ASSIGNMENT_SECURITY = 100)), // Doesn't work
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Grid Check",				/datum/event/grid_check, 				50,		list(ASSIGNMENT_ENGINEER = 60)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Radiation Storm",			/datum/event/radiation_storm, 			1,		list(ASSIGNMENT_MEDICAL = 50), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Gravity Anomaly",			/datum/event/grav_event,				200),
...
/datum/event_container/major
	...
	available_events = list(
		...
		//new /datum/event_meta(EVENT_LEVEL_MAJOR, "Containment Breach",	/datum/event/prison_break/station,0,list(ASSIGNMENT_ANY = 5)),  // Throws errors
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Meteor Wave",			/datum/event/meteor_wave,		10,	list(ASSIGNMENT_ENGINEER =  3),	1),
