...
/datum/event/brand_intelligence/announce()
	command_announcement.Announce("Rampant brand intelligence has been detected aboard [station_name()]. Engineering personnel must contain all vending machines.", "AUTOMATED ALERT: Spotaneous Machine Sentience")
