		...
		if(prob(5))
			...
			switch(pick(1,2,3,4,5,6,7))
				...
				if(5)
					...
					"Greetings sir, I regretfully to inform you that as I lay dying here due to my lack of heirs I have chosen you to recieve the full sum of my lifetime savings of 1.5 billion credits")
				if(6)
				...
				if(7)
					...
					"You have won tickets to the newest crime drama DETECTIVE MYSTERY IN THE CALAMITY CAPER!",\
