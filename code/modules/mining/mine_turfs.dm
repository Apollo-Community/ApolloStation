...
/turf/simulated/mineral/random
	...
	var/mineralSpawnChanceList = list("Uranium" = 5, "Platinum" = 5, "Iron" = 10, "Coal" = 10, "Diamond" = 1, "Gold" = 5, "Silver" = 5, "Phoron" = 10, "Tritium" = 1)
...
/turf/simulated/mineral/lunar
	var/mineralSpawnChanceList = list("Platinum" = 5, "Iron" = 35, "Coal" = 35, "Silver" = 5)
