/mob/living/carbon/alien/larva/confirm_evolution()
	...
	src << "<B>Hunters</B> <span class='notice'> are strong and agile, able to hunt away from the hive and rapidly move through ventilation shafts. Hunters generate phoron slowly and have low reserves.</span>"
	...
	src << "<B>Drones</B> <span class='notice'> are the working class, offering the largest phoron storage and generation. They are the only caste which may evolve again, turning into the dreaded alien queen.</span>"
