...
/mob/living/silicon/pai/emp_act(severity)
	...
	if(prob(20))
		...
		for (var/mob/M in viewers(T))
			M.show_message("<span class='alert'>A shower of sparks spray from [src]'s inner workings.</span>", 3, "<span class='alert'>You hear and smell the ozone hiss of electrical sparks being expelled violently.</span>", 2)
		return src.death(0)
