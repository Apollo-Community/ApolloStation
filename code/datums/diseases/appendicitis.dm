...
/datum/disease/appendicitis/stage_act()
	...
	if(stage == 1)
		if(prob(5))
			affected_mob << "<span class='alert'> You feel a stinging pain in your abdomen!</span>"
			affected_mob.emote("me",1,"winces slightly.")
	if(stage > 1)
		if(prob(3))
			affected_mob << "<span class='alert'> You feel a stabbing pain in your abdomen!</span>"
	...
	if(stage > 2)
		if(prob(1))
			if (affected_mob.nutrition > 100)
				...
				affected_mob << "<span class='alert'> You gag as you want to throw up, but there's nothing in your stomach!</span>"
				affected_mob.Weaken(10)
				affected_mob.adjustToxLoss(3)
	if(stage > 3)
		if(prob(1) && ishuman(affected_mob))
			var/mob/living/carbon/human/H = affected_mob
			H << "<span class='alert'> Your abdomen is a world of pain!</span>"
			H.Weaken(10)
