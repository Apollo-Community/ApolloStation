...
/datum/disease/beesease/stage_act()
	...
	switch(stage)
		if(1)
			if(prob(2))
				affected_mob << "<span class='alert'>You feel like something is moving inside of you</span>"
		if(2) //also changes say, see say.dm
			if(prob(2))
				affected_mob << "<span class='alert'>You feel like something is moving inside of you</span>"
			if(prob(2))
				affected_mob << "<span class='alert'>BZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ</span>"
		if(3)
