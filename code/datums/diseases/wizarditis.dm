...
/datum/disease/wizarditis/stage_act()
	...
	switch(stage)
		if(2)
			...
			if(prob(1)&&prob(50))
				affected_mob << "<span class='alert'>You feel [pick("that you don't have enough mana.</span>", "that the winds of magic are gone.", "an urge to summon familiar.")]"
		...
		if(3)
			...
			if(prob(1)&&prob(50))
				affected_mob << "<span class='alert'>You feel [pick("the magic bubbling in your veins</span>","that this location gives you a +1 to INT","an urge to summon familiar.")]."
		...
		if(4)
			...
			if(prob(1))
				...
				return
			if(prob(1)&&prob(50))
				affected_mob << "<span class='alert'>You feel [pick("the tidal wave of raw power building inside</span>","that this location gives you a +2 to INT and +1 to WIS","an urge to teleport")]."
