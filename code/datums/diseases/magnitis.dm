...
/datum/disease/magnitis/stage_act()
	...
	switch(stage)
		if(2)
			if(prob(2))
				affected_mob << "<span class='alert'> You feel a slight shock course through your body.</span>"
			if(prob(2))
		...
		if(3)
			if(prob(2))
				affected_mob << "<span class='alert'> You feel a strong shock course through your body.</span>"
			if(prob(2))
				affected_mob << "<span class='alert'> You feel like clowning around.</span>"
			if(prob(4))
		...
		if(4)
			if(prob(2))
				affected_mob << "<span class='alert'> You feel a powerful shock course through your body.</span>"
			if(prob(2))
				affected_mob << "<span class='alert'> You query upon the nature of miracles.</span>"
			if(prob(8))
