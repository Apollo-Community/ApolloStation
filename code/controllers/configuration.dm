...
//	var/enable_authentication = 0		// goon authentication
	...
	var/list/admin_levels= list()					// Defines which Z-levels which are for admin functionality, for example including such areas as Central Command and the Syndicate Shuttle
	var/list/contact_levels = list(1)			// Defines which Z-levels which, for example, a Code Red announcement may affect
	var/list/player_levels = list(1)	// Defines all Z-levels a character can typically reach
