...
/obj/machinery/atmospherics/unary/outlet_injector/examine()
	..()
	usr << "The [src.name] is tagged with the ID: [id]"

/obj/machinery/atmospherics/unary/outlet_injector/attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
	if(!istype(W, /obj/item/device/multitool))
		return ..()
	id = input(usr,"Enter new ID","[src.name] ID Modifier") as text
